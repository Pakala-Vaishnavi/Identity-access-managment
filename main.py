...
def mainMenu():
    ...
    layout = [[sg.Menu(menu_def, tearoff=False, pad=(200, 1))],
                [sg.Text('Intelligent office access management system ', font='Helvetica 30', justification = 'center')],
    ...
    window = sg.Window('Intelligent office access management system', layout,auto_size_buttons=False, element_justification='c')
    ...
    while True:
        ...
        if event == "Quit" or event == "Exit" or event == sg.WIN_CLOSED:
            ...
            os.startfile(path)
        elif event =="Open Employee Records":
